...
export default function ServicesProjects({ projects }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-7 gridContainerMargin">
      {/* LEFT COLUMN */}
      ...
      >
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="p-4 text-gray-700">{project.about}</p>
                ...
                ${isQuestion ? "grid-rows-[1fr] py-2" : "grid-rows-[0fr]"}`}
                    >
                      <div className="overflow-hidden px-3">
                        <p className="text-gray-700">{link.answer}</p>
                      </div>
                    </div>
                  </div>
                );
